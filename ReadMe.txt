...
Theme.java (Centralized UI color/font styling)
Threads.java (Contains CustomerGenerator and Server threads)
OrderQueue.java
Models.java
MenuLoader.java
Logger.java
ObserverInterfaces.java
SimulationTests.java (JUnit Test Suite)
menu.csv (Data file)
...
Closing the Shop: Click "Close Shop (Stop Simulation)" in the POS window to lock the doors. The Baristas will finish the remaining queue, save the simulation_log.txt file, and cleanly exit.